...
.verbose   = { .loc = "SLURM_EOVERB", .rem = "SLURM_ERVERB", .ear = "EAR_VERBOSE" },
.policy    = { .loc = "SLURM_EOPOLI", .rem = "SLURM_ERPOLI", .ear = "EAR_POWER_POLICY" },
.policy_th = { .loc = "SLURM_EOPOTH", .rem = "SLURM_ERPOTH", .ear = "EAR_POWER_POLICY_TH" },
.frequency = { .loc = "SLURM_EOFREQ", .rem = "SLURM_ERFREQ", .ear = "EAR_FREQUENCY" },
.p_state   = { .loc = "SLURM_EOPSTA", .rem = "SLURM_ERPSTA", .ear = "EAR_P_STATE" },
.learning  = { .loc = "SLURM_EOLERN", .rem = "SLURM_ERLERN", .ear = "EAR_LEARNING_PHASE" },
.tag       = { .loc = "SLURM_EOETAG", .rem = "SLURM_ERETAG", .ear = "EAR_ENERGY_TAG" },
.path_usdb = { .loc = "SLURM_EOUSDB", .rem = "SLURM_ERUSDB", .ear = "EAR_USER_DB_PATHNAME" },
.path_trac = { .loc = "SLURM_EOTRAC", .rem = "SLURM_ERTRAC", .ear = "EAR_PATH_TRACE" },
