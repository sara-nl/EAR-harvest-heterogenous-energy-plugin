...
int _opt_ear (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		if (strcmp(buffer, "ON") == 0) {
			setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
		} else if (strcmp(buffer, "OFF") == 0) {
			setenv_agnostic(NULL, "OPT_LIBRARY", "0", 1);
		} else {
...
int _opt_ear_learning (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "OPT_LEARNING_PHASE", buffer, 1);
		setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
	}
...
int _opt_ear_policy (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "OPT_POWER_POLICY", buffer, 1);
		setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
	}
...
int _opt_ear_frequency (int val, const char *optarg, int remote)
{
    ...
    if (!remote)
    {
        ...
        setenv_agnostic(NULL, "OPT_FREQUENCY", buffer, 1);
        setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
    }
...
int _opt_ear_threshold (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "OPT_POWER_POLICY_TH", buffer, 1);
		setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
	}
...
int _opt_ear_user_db (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "OPT_USER_DB_PATHNAME", optarg, 1);
		setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
	}
...
int _opt_ear_verbose (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "OPT_LIBRARY_VERBOSE", buffer, 1);
		setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);

		// Obsolete
		//setenv_agnostic(NULL, "EAR_VERBOSE", buffer, 1);
	}
...
int _opt_ear_traces (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "OPT_PATH_TRACE", optarg, 1);
		setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
	}
...
int _opt_ear_mpi_dist(int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "OPT_MPI_DIST", optarg, 1);
		setenv_agnostic(NULL, "OPT_LIBRARY", "1", 1);
	}
