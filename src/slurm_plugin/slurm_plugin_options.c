...
int _opt_ear (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		if (strcmp(buffer, "ON") == 0) {
			...
			setenv_agnostic(NULL, ENV_LIB_EN, "0", 1);
		} else {
...
int _opt_ear_learning (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "PLUG_LEARNING_PHASE", buffer, 1);
		setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
	}
...
int _opt_ear_frequency (int val, const char *optarg, int remote)
{
    ...
    if (!remote)
    {
        ...
        setenv_agnostic(NULL, "PLUG_FREQUENCY", buffer, 1);
        setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
    }
...
int _opt_ear_threshold (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "PLUG_POWER_POLICY_TH", buffer, 1);
		setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
	}
...
int _opt_ear_user_db (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "PLUG_USER_DB_PATHNAME", optarg, 1);
		setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
	}
...
int _opt_ear_verbose (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "EAR_LIBRARY_VERBOSE", buffer, 1);
		setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
...
int _opt_ear_traces (int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "PLUG_TRACE_PATH", optarg, 1);
		setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
	}
...
int _opt_ear_mpi_dist(int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "PLUG_MPI_DIST", optarg, 1);
		setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
	}
...
int _opt_ear_tag(int val, const char *optarg, int remote)
{
	...
	if (!remote)
	{
		...
		setenv_agnostic(NULL, "PLUG_ENERGY_TAG", optarg, 1);
		setenv_agnostic(NULL, ENV_LIB_EN, "1", 1);
	}
	return (ESPANK_SUCCESS);
}
