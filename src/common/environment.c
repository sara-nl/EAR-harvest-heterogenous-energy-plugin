...
int getenv_ear_power_policy() {
    ...
    if (my_policy != NULL) {
        if ((strcmp(my_policy, "MIN_ENERGY_TO_SOLUTION") == 0) ||
            (strcmp(my_policy, "min_energy_to_solution") == 0))
            conf_ear_power_policy = MIN_ENERGY_TO_SOLUTION;
        else if ((strcmp(my_policy, "MIN_TIME_TO_SOLUTION") == 0) ||
                 (strcmp(my_policy, "min_time_to_solution") == 0))
            conf_ear_power_policy = MIN_TIME_TO_SOLUTION;
        else if ((strcmp(my_policy, "MONITORING_ONLY") == 0) ||
                 (strcmp(my_policy, "monitoring_only") == 0))
            conf_ear_power_policy = MONITORING_ONLY;
    }
    ...
    switch (conf_ear_power_policy) {
        case MIN_ENERGY_TO_SOLUTION:
            ...
            if (my_th != NULL) {
                ...
                if ((conf_ear_power_policy_th > 1.0) || (conf_ear_power_policy_th < 0))
                    conf_ear_power_policy_th = DEFAULT_MIN_ENERGY_TH;
        ...
        case MIN_TIME_TO_SOLUTION:
            ...
            if (my_th != NULL) {
                conf_ear_power_policy_th = strtod(my_th, NULL);
                if ((conf_ear_power_policy_th < DEFAULT_MIN_TIME_TH) ||
                    (conf_ear_power_policy_th > 1.0))
                    conf_ear_power_policy_th = DEFAULT_MIN_TIME_TH;
