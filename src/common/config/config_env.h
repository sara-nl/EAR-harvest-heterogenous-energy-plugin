...
#define SHARE_INFO_PER_PROCESS "SHARE_INFO_PER_PROCESS"
#define SHARE_INFO_PER_NODE "SHARE_INFO_PER_NODE"
#define REPORT_NODE_SIGNATURES "REPORT_NODE_SIGNATURES"
#define REPORT_ALL_SIGNATURES "REPORT_ALL_SIGNATURES"
