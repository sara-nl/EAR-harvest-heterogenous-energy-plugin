...
#define SLURM_LIB_PATH      "/usr/lib64"
#define PAPI_LIB_PATH       "/hpc/base/ctt/packages/papi/5.5.1/lib"
#define GSL_LIB_PATH        "/hpc/base/ctt/packages/gsl/1.16/lib"
#define EAR_INSTALL_PATH    "/home/xjcorbalan/my_ear"
