...
void print_my_node_conf(my_node_conf_t *my_node_conf)
{
	...
	verbose(VCCONF,"max_sig_power %.0lf min_sig_power %.0lf error_power %.0lf max_temp %lu powercap %ld max_powercap %ld powercap_type %d",my_node_conf->max_sig_power,my_node_conf->min_sig_power,my_node_conf->max_error_power,my_node_conf->max_temp,my_node_conf->powercap,my_node_conf->max_powercap,my_node_conf->powercap_type);
}
