...
int append_application_text_file(char *path, application_t *app)
{
	...
	/*USERNAME;JOB_ID;NODENAME;APPNAME;AVG.FREQ;DEF.FREQ.TIME;CPI;TPI;GBS;DC-NODE-POWER;DRAM-POWER;PCK-POWER;DEF.FREQ;POLICY;POLICY_TH;LOOP_ID;SIZE;LEVEL;CYCLES;INSTRUCTIONS;L1_MISSES;L2_MISSES;L3_MISSES;GFLOPS;DPSINGLE_OPS;DP128_OPS;DP256_OPS;DP512_OPS*/
    application_t *a;
    int fd, ret;
