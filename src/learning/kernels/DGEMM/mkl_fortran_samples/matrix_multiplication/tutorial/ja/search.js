...
function ShowSearchResultsWindow() {
  ...
  newWindow.document.write('<div style="height:25px;width:98%;padding:8px 0px 3px 2%;background-color:#545444;color:#e2e2e2;">検索結果<a onclick="location.reload();" style="float:right;color:#e2e2e2;background-color:#747474;cursor:pointer;padding:2px 5px 0px 5px;margin-right:5px;">閉じる</a></div>\n');
  newWindow.document.write('<div style="height:100%;width:98%;padding-left:2%">\n');

  //Fill SearchResults List
  newWindow.document.write('<p>結果: ' + SearchResults.length + '</p>\n');
  for(var i=0;((i<SearchResults.length) && (i<500));i++) {
    //Search Topic Title
    ...
    newWindow.document.write('<p>タイトル: '+ aTitle +'<br>\n');
