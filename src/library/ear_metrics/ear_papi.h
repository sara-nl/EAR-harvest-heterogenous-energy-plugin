...
void metrics_end(uint whole_app, int my_id, char *summary_file, ulong int *eru);
...
void metrics_get_extra_metrics(application_t_extended *my_extra);
void metrics_print_extra_metrics(application_t *my_sig, application_t_extended *my_extra,
