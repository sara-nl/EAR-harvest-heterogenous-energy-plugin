...
{
	api_mpif.allgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, ierror);
}
...
{
	api_mpif.allreduce(sendbuf, recvbuf, count, datatype, op, comm, ierror);
}
...
{
	api_mpif.alltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, ierror);
}
...
{
	api_mpif.alltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm, ierror);
}
...
{
	api_mpif.bcast(buffer, count, datatype, root, comm, ierror);
}
...
{
	api_mpif.bsend(buf, count, datatype, dest, tag, comm, ierror);
}
...
{
	api_mpif.bsend_init(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.cancel(request, ierror);
}
...
{
	api_mpif.cart_create(comm_old, ndims, dims, periods, reorder, comm_cart, ierror);
}
...
{
	api_mpif.cart_sub(comm, remain_dims, comm_new, ierror);
}
...
{
	api_mpif.comm_create(comm, group, newcomm, ierror);
}
...
{
	api_mpif.comm_dup(comm, newcomm, ierror);
}
...
{
	api_mpif.comm_free(comm, ierror);
}
...
{
	api_mpif.comm_rank(comm, rank, ierror);
...
{
	api_mpif.comm_size(comm, size, ierror);
}
...
{
api_mpif.comm_spawn(command, argv, maxprocs, info, root, comm, intercomm, array_of_errcodes, ierror);
}
...
{
api_mpif.comm_spawn_multiple(count, array_of_commands, array_of_argv, array_of_maxprocs, array_of_info, root, comm, intercomm, array_of_errcodes, ierror);
}
...
{
	api_mpif.comm_split(comm, color, key, newcomm, ierror);
}
...
{
	api_mpif.file_read(fh, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.file_read_all(fh, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.file_read_at(fh, offset, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.file_read_at_all(fh, offset, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.file_write(fh, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.file_write_all(fh, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.file_write_at(fh, offset, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.file_write_at_all(fh, offset, buf, count, datatype, status, ierror);
}
...
{
	api_mpif.gather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, ierror);
}
...
{
	api_mpif.gatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, ierror);
}
...
{
	api_mpif.get(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count, target_datatype, win, ierror);
}
...
{
	api_mpif.ibsend(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.init_thread(required, provided, ierror);
}
...
{
	api_mpif.intercomm_create(local_comm, local_leader, peer_comm, remote_leader, tag, newintercomm, ierror);
}
...
{
	api_mpif.intercomm_merge(intercomm, high, newintracomm, ierror);
}
...
{
	api_mpif.iprobe(source, tag, comm, flag, status, ierror);
}
...
{
	api_mpif.irecv(buf, count, datatype, source, tag, comm, request, ierror);
}
...
{
	api_mpif.irsend(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.isend(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.issend(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.probe(source, tag, comm, status, ierror);
}
...
{
	api_mpif.put(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count, target_datatype, win, ierror);
}
...
{
	api_mpif.recv(buf, count, datatype, source, tag, comm, status, ierror);
}
...
{
	api_mpif.recv_init(buf, count, datatype, source, tag, comm, request, ierror);
}
...
{
	api_mpif.reduce(sendbuf, recvbuf, count, datatype, op, root, comm, ierror);
}
...
{
	api_mpif.reduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op, comm, ierror);
}
...
{
	api_mpif.request_free(request, ierror);
}
...
{
	api_mpif.request_get_status(request, flag, status, ierror);
}
...
{
	api_mpif.rsend(buf, count, datatype, dest, tag, comm, ierror);
}
...
{
	api_mpif.rsend_init(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.scan(sendbuf, recvbuf, count, datatype, op, comm, ierror);
}
...
{
	api_mpif.scatter(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, ierror);
}
...
{
	api_mpif.scatterv(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, ierror);
}
...
{
	api_mpif.send(buf, count, datatype, dest, tag, comm, ierror);
}
...
{
	api_mpif.send_init(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.sendrecv(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype, source, recvtag, comm, status, ierror);
}
...
{
	api_mpif.sendrecv_replace(buf, count, datatype, dest, sendtag, source, recvtag, comm, status, ierror);
}
...
{
	api_mpif.ssend(buf, count, datatype, dest, tag, comm, ierror);
}
...
{
	api_mpif.ssend_init(buf, count, datatype, dest, tag, comm, request, ierror);
}
...
{
	api_mpif.startall(count, array_of_requests, ierror);
}
...
{
	api_mpif.test(request, flag, status, ierror);
}
...
{
	api_mpif.testall(count, array_of_requests, flag, array_of_statuses, ierror);
}
...
{
	api_mpif.testany(count, array_of_requests, index, flag, status, ierror);
}
...
{
	api_mpif.testsome(incount, array_of_requests, outcount, array_of_indices, array_of_statuses, ierror);
}
...
{
	api_mpif.wait(request, status, ierror);
}
...
{
	api_mpif.waitall(count, array_of_requests, array_of_statuses, ierror);
}
...
{
	api_mpif.waitany(count, requests, index, status, ierror);
}
...
{
	api_mpif.waitsome(incount, array_of_requests, outcount, array_of_indices, array_of_statuses, ierror);
}
...
{
	api_mpif.win_complete(win, ierror);
}
...
{
	api_mpif.win_create(base, size, disp_unit, info, comm, win, ierror);
}
...
{
	api_mpif.win_fence(assert, win, ierror);
}
...
{
	api_mpif.win_post(group, assert, win, ierror);
}
...
{
	api_mpif.win_start(group, assert, win, ierror);
}
...
{
    api_mpif.iallgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request, ierror);
}
...
{
    api_mpif.iallgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcount, displs, recvtype, comm, request, ierror);
}
...
{
    api_mpif.iallreduce(sendbuf, recvbuf, count, datatype, op, comm, request, ierror);
}
...
{
    api_mpif.ialltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request, ierror);
}
...
{
    api_mpif.ialltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, request, comm, ierror);
}
...
{
    api_mpif.ibarrier(comm, request, ierror);
}
...
{
    api_mpif.ibcast(buffer, count, datatype, root, comm, request, ierror);
}
...
{
    api_mpif.igather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierror);
}
...
{
    api_mpif.igatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm, request, ierror);
}
...
{
    api_mpif.ireduce(sendbuf, recvbuf, count, datatype, op, root, comm, request, ierror);
}
...
{
    api_mpif.ireduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op, comm, request, ierror);
}
...
{
    api_mpif.iscan(sendbuf, recvbuf, count, datatype, op, comm, request, ierror);
}
...
{
    api_mpif.iscatter(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierror);
}
...
{
    api_mpif.iscatterv(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierror);
}
